...
public class MembersController {
	...
	@Operation(summary = "POS 查詢會員", description = "根據手機號碼查詢正式會員資料（支援 09 本地格式）")
	public MembersRes getByPhone(@RequestParam("phone") String phone) {
		return membersService.getMemberByPhone(phone);
	}
