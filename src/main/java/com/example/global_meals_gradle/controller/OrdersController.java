...
public class OrdersController {
	...
	// // 前端點擊「前往付款」時請求的 API
	// @GetMapping("/goPay")
	// @Operation(summary = "前往付款頁面", description = "根據選擇的付款方式 (ECPAY/LINEPAY)
	// 轉導至金流平台")
	// public String goPay(@RequestParam String orderDateId, @RequestParam("id")
	// String id, //
	...
	// public String linePayConfirm(@RequestParam("transactionId") String
	// transactionId, // LINE Pay 給的交易序號
